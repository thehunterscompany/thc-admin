...
const renderStepForms = (step, values) => {
  if (step === 0) return <PersonalFields formField={formField.personal} values={values} />
  if (step === 1) return <FinancialFields formField={formField.financial} values={values} />
  if (step === 2 && values?.simulation === 2) return null
  if (step === 2) return <OperationalFields formField={formField.operational} values={values} />
  // case 2:
