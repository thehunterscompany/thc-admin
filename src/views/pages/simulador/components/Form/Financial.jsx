...
const FinancialFields = ({ formField, values }) => {
  const { mainEmployment, laborTime, earnings, currency, passive, extra } = formField
      ...
      array.push(
        <React.Fragment>
          <Grid item xs={12} md={6}>
            <InputField name={`tenants[${i}].firstNames`} label={'Nombres'} type="text" fullWidth />
          </Grid>
          <Grid item xs={12} md={6}>
            <InputField name={`tenants[${i}].lastNames`} label="Apellidos" type="text" fullWidth />
          </Grid>
          <Grid item xs={12} md={6}>
            <InputField
              name={currency.name}
  ...
  return (
    <React.Fragment>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <InputField name={laborTime.name} label={laborTime.label} type="text" fullWidth />
        </Grid>
        <Grid item xs={12} md={6}>
          <SelectField
            name={currency.name}
        ...
        <Grid item xs={12} md={6}>
          <InputField name={earnings.name} label={earnings.label} type="text" fullWidth />
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <InputField name={passive.name} label={passive.label} type="text" fullWidth />
        </Grid>
        ...
        {extraTenants ? (
          <Grid item xs={12} md={extraTenants > 0 && extraTenants < 4 ? 6 : 12}>
            <FormControl>
              <FormControlLabel
                control={<Button onClick={handleRemoveClick}>Elimar Titular</Button>}
              />
            </FormControl>
          </Grid>
        ) : null}
