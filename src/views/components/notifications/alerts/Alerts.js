    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              React Alert is prepared for any length of text, as well as an optional close
              button. For a styling, use one of the <strong>required</strong> contextual{' '}
              <code>color</code> props (e.g., <code>primary</code>). For inline dismissal,
              use the{' '}
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <Example href="components/alert#link-color">
              ...
              <CAlert color="info">
                A simple info alert with <CAlertLink href="#">an example link</CAlertLink>
              ...
              <CAlert color="dark">
                A simple dark alert with <CAlertLink href="#">an example link</CAlertLink>
                . Give it a click if you like.
              </CAlert>
            </Example>
          </CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              Alerts can also be easily dismissed. Just add the <code>dismissible</code>{' '}
              prop.
            </p>
