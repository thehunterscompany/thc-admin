        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              is required on each <code>&lt;CFormInput&gt;</code> as our method of
              CSS-only floating labels uses the <code>:placeholder-shown</code>{' '}
              pseudo-element. Also note that the <code>&lt;CFormInput&gt;</code> must come
              first so we can utilize a sibling selector (e.g., <code>~</code>).
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-medium-emphasis small">
              To set a custom height on your <code>&lt;CFormTextarea;&gt;</code>, do not
              use the <code>rows</code> attribute. Instead, set an explicit{' '}
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              but unlike <code>&lt;CFormInput&gt;</code>s, they&#39;ll always show the{' '}
